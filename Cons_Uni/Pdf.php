...
// Text
$txt=" 
<p>EL(A) SUSCRITO ".$puestoFirma." DEL MINISTERIO PUBLICO HACE CONSTAR QUE <vb>".$nombre." ".$apellido."</vb> ".$msg.""." ACTUALMENTE SE DESEMPEÑA COMO: ".trim($desempenio)." "."ASIGNADO A: ".$asignacion.".</p>
";


$texto1=" <p>PARA LOS FINES QUE AL INTERESADO LE CONVENGA SE LE EXTIENDE LA PRESENTE EN LA CIUDAD DE TEGUCIGALPA, MUNICIPIO DEL DISTRITO CENTRAL A ".$fechaActual.".
</p>";
