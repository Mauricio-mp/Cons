...
var mensaje='Historial de Conatncia de 14vo';
var cons='14';
...
<section style="background-color: #F9FAFA;">
  <div class="center container">
    <form method="POST" >
      <h1 style="text-align: center">Historial de Constancia 14VO</h1>
      <div  class="form-group">
  ...
  <div style="text-align: center"><h1><?php echo "Reporte desde ".$_POST['fechaMinima']." al ".$_POST['fechaMaxima']; ?></h1></div>
   ...
   if (isset($_POST['BtnAceptar'])) {
     ...
     include('../crearConexionGECOMP.php');
        ...
        echo '<div class="row">
        <div class="col text-center">
          <a href="excel.php?fecha1='.$fechaMinima.'&fecha2='.$fechaMaxima.'&cons=14&mensaje=Historial de bono 14vo">
            Generar XLS General
          </a>
        </div>
      </div>';          
    ...
    echo "</script>";
              ...
              $consultar=mssql_query("SELECT * FROM CONSTANCIA_GENERADA WHERE Fecha_Creacion between ' $fechaMinima' and '$fechaMaxima' AND cPeriodo like '14%'");
