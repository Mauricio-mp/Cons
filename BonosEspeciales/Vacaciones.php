...
function myFunction() {
  ...
  var opcion='<?php echo $opcion; ?>'
   ...
   var mensaje='Historial de Conatncia de vacaciones';
   var cons='7';
...
<section style="background-color: #F9FAFA;">
  <div class="center container">
    <form method="POST" >
      <h1 style="text-align: center">Historial de Constancia Vacaciones</h1>
      <div  class="form-group">
  ...
  <div style="text-align: center"><h1><?php echo "Reporte desde ".$_POST['fechaMinima']." al ".$_POST['fechaMaxima']; ?></h1></div>
   ...
   if (isset($_POST['BtnAceptar'])) {
     ...
     include('../crearConexionGECOMP.php');
        ...
        echo '<div class="row">
        <div class="col text-center">
          <a href="excel.php?fecha1='.$fechaMinima.'&fecha2='.$fechaMaxima.'&cons=7&mensaje=Historial de bono Vacaciones">
            Generar XLS General
          </a>
        </div>
      </div>';          
    ...
    echo "</script>";
          ...
          while ($fila=mssql_fetch_array($consultar)) {
            ...
            if ($Datos=mssql_fetch_array($optenerNombre)) {
              $fila['Id_Constancia_Dirigida']=utf8_encode($Datos['NOMBRE_COOPERATIVA']);
            }
