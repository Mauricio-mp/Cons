...
if ($comprara < $fechaAactual) {
                      ...
                      $concatenacion = date("Y-m-d",strtotime($fechaAcuerdo_anioactual2."- 1 month"));;
                         ...
                         $fechaAcuerdo_anioactual2 ="VAC".$aniomasuno.$identidad;
 ...
 //Evaluar si ya saco ese bono de vacaciones em ambas base de datos, con fecha de acuerdo y anio actual mas 1
                      ...
                      include('../crearConexionGECOMP.php');
                      $mostrarDatos22=mssql_query("SELECT * FROM CONSTANCIA_GENERADA WHERE Estado=1 AND Codigo_Bonos='$fechaAcuerdo_anioactual2'");
                        if ($row22=mssql_fetch_array($mostrarDatos22)) {
                        ...
                        $meses = $row44[0];
                            ...
                            //Comparar si la fecha de aniversario de vacaciones con el a;o a solicitar, aun esta dentro del tiempo que la cooperativa esta autoriza a adelantar
                                      $datetime1=new DateTime($fechaAactual);
                                      $datetime2=new DateTime($concatenacion);
                                      ...
                                      $intervalAnos = $interval->format("%y")*12;
                                        ...
                                        if ($valor > $meses) {
                                            $message =  "Meses que faltan"." ".$valor."    "."Meses de Cooperativa"." ".$meses." ".$fechaAcuerdo_anioactual2." "."Aun no puede solicitar este bono para este periodo, ";
                                            $variable_validador= 1;
                                          }
