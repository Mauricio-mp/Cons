...
require('ConversionSueldo2.php');
require('ConversionFecha2.php');
             ...
             $mostrarDatos2=mssql_query("SELECT sum(ndedamt) as embargo FROM prmisd where cempno='$numeroEmpleado' and ctrsno='$dato' and cdedcode=970");
                if ($row2=mssql_fetch_array($mostrarDatos2)) {
                        //se encontro deduccion con el codigo de embargo
                          ...
                          $mensaje_embargos="No tiene comprometido su bono de vacaciones, el cual se pagará el mes de ".$mesletras." del año ".$aniomostrar.".";
                               }else{

                         $embargo_letras=convertir($dato1);
                         $mesletras=fecha3($mesmostrar);

                          $mensaje_embargos="Tiene comprometido su bono de vacaciones en ".strtolower($embargo_letras).", el cual se pagará el mes de ".$mesletras." del año ".$aniomostrar.".";
                               }
                      }else{
                            $mesletras=fecha3($mesmostrar);
                          $mensaje_embargos="No tiene comprometido su bono de vacaciones, el cual se pagará el mes de ".$mesletras." del año ".$aniomostrar.".";
