...
if ($ppp[1]=='Tipo_Constancia') {
   if ($fila[1]=="1") {
            ...
            if ($fila[1]=="5") {
              $fila[1]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[1]=="6") {
...
if ($ppp[2]=='Tipo_Constancia') {
   if ($fila[2]=="1") {
            ...
            if ($fila[2]=="5") {
              $fila[2]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[2]=="6") {
...
if ($ppp[3]=='Tipo_Constancia') {
   if ($fila[3]=="1") {
            ...
            if ($fila[3]=="5") {
              $fila[3]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[3]=="6") {
...
if ($ppp[4]=='Tipo_Constancia') {
  if ($fila[4]=="1") {
            ...
            if ($fila[4]=="5") {
              $fila[4]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[4]=="6") {
...
if ($ppp[5]=='Tipo_Constancia') {
    if ($fila[5]=="1") {
            ...
            if ($fila[5]=="5") {
              $fila[5]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[5]=="6") {
...
if ($ppp[6]=='Tipo_Constancia') {
    if ($fila[6]=="1") {
            ...
            if ($fila[6]=="5") {
              $fila[6]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[6]=="6") {
...
if ($ppp[7]=='Tipo_Constancia') {
    if ($fila[7]=="1") {
            ...
            if ($fila[7]=="5") {
              $fila[7]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[7]=="6") {
...
if ($ppp[8]=='Tipo_Constancia') {
    if ($fila[8]=="1") {
            ...
            if ($fila[8]=="5") {
              $fila[8]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[8]=="6") {
...
if ($ppp[9]=='Tipo_Constancia') {
  if ($fila[9]=="1") {
            ...
            if ($fila[9]=="5") {
              $fila[9]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[9]=="6") {
...
if ($ppp[10]=='Tipo_Constancia') {
  if ($fila[10]=="1") {
            ...
            if ($fila[10]=="5") {
              $fila[10]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[10]=="6") {
...
if ($ppp[0]=='Tipo_Constancia') {
  if ($fila[0]=="1") {
            ...
            if ($fila[0]=='5') {
              $fila[0]="Constancia para Bono de 13AVO-14VO";
            }
            if ($fila[0]=="6") {
