...
$texto = "El (a) suscrito ".utf8_encode($puestoFirma)." del Ministerio Público hace constar que ".$txt.", con tarjeta de identidad No. ".$identidad." ha laborado en esta institución bajo la modalidad de contrato en el periodo comprendido del ".$FechaIncioContrato." al ".$FechaFinalContrato." ".$mensaje.", desempeñando el cargo de ".trim($desempenio)." asignado a ".utf8_encode($asignacion).", interponiendo su retiro Voluntario a partir del ".$FechaRetiro." ante el despacho del señor ".$Autoriza." de la Republica, declarada con lugar según Resolución No. ".$Resolucion." Notificado el ".$optenerfechaResolucion." a las ".$optenerHora;
