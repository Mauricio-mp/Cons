...
$texto = "El (a) suscrito ".utf8_encode($puestoFirma)." del Ministerio Público hace constar que ".$txt." ha laborado en esta institución por contrato a partir del ".$FechaIncioContrato." al ".$FechaFinalContrato." ".$mensaje.", actualmente se desempeña como ".trim($desempenio)." asignado a ".utf8_encode($asignacion);
